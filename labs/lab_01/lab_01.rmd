...
1.  How many classes have N/A listed for a professor?

```{r}
umd_courses |>
  na_counts_base <- lapply(umd_courses, function(x) sum(is.na(x)))
  print(na_counts_base)


```

A: So, I attempted to create an object called instructors, then tried to sum up the number of NA's in the instructors column. I am not sure what I am doing wrong. I found this line of code online and attempted to change it for the purpose of my dataset.
