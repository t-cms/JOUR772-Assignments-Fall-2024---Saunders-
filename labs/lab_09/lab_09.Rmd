...
```{r}
md_county_gov_data<-read_csv("data/md_gov_county.csv") |> clean_names()
md_county_gov18_data <- read_csv("data/md_gov_county_18.csv") |> clean_names()

# Prepare data for export

# Export CSV

# Link to chart on Datawrapper
