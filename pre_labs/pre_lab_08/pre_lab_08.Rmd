...
**Task** Complete and run the following code to create a dataframe of top 10 counties with the biggest change in unaffiliated voters in Maryland. In the space below, explain what each step of the code below is doing in English. **Answer:**

**Storing everything back into the dataframe and creating a new column of the different between unaffiliated voters in 2022 to 2024. Then arranging it into descending so we can see the the top counties with the biggest change in unaffiliated voters, selecting the county and unaffiliated difference to know which counties have the biggest change. Lastly, putting head of ten so we can just see the top ten counties.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: A blank gray box with nothing in it.**
...
weight is a way to show r from where r is going to grab how big that bar is,
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: A bar graph of the counties with their unaffiliated differences.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The bar chart is more organized with it going from smallest difference to largest difference. Reordering the county by the unaffiliated difference.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: We flipped the bar chart horizontally and now there is spacing between the x countries value.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: We dropped the grey background and added a theme of minimal for us to be able to see the graph better.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: The bar graph is more colorful and look way more appealing than when we started.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: We added a title, x and y values, and caption to the bar graph.**
...
So, let's load some contribution data from WinRed, a Republican online platform for campaign contributions.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a table with a data and total_contributions column.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a line chart with not enough information on the x-axis to truly understand what is going by each month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a haphazard looking line chart with a scattered line on it.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: The x values are now skewed making it for better readability.**
