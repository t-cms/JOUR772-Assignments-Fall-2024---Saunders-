...
### Task 14: Load the bing lexicon and produce sentiments for our 2022 and 2024 unique words

**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: I think for the most part the sentiments goes with each word, I did find a couple of differences such as like being negative when I think it should be considered a stop word.**
