...
#taken away certain columns to be able to see the clear correlation between spenditure in education by pupil compared to gdp growth and population change 
```
...
#caculate the p-value, there is a strong negative correlation the more u spend per pupil the less population (maybe because people are leaving high income cities and moving to places that are less expensive)
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The correlation is \`0.06 which is not as good as the previous one and the P-value is 0.6785 prompting me to think that it is not really a correlation between how much spending per pupil and gdp growth in the county. Additionally, I believe, that we as data journalists; shouldn't rely entirely too much on P-value considering there may be other factors that are influencing what we are looking at.**
...
#people that spent more money on pupils had slower population growth 
```
