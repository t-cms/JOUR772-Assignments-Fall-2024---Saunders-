...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer: It contains zip codes and names of areas in MD. Also has coordinations.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: It is a very specific map of MD**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Gives me a data table of counties information.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: It gives ma table with the MD counties**
...
**Task** Run the following code. Describe the output in the space below. **Answer: A MD county map**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This overlaps the two previous maps together.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Gives me a dataset of how many foreclosures per zip code in March 2023**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Joining zip code geographical data to the foreclosure data. So we can see all the information surrounding the zip code and know how many foreclosures that happened.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: A map showcasing the number of foreclosures in March 2023 through color.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer:** Foreclosure rates appear to be relatively high in parts of northern and central Maryland, moderate in much of the state, and particularly low in isolated regions, indicating diverse economic conditions across Maryland’s regions.
