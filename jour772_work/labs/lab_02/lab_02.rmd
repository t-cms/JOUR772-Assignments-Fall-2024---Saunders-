...
**A1: Anthropology and Atmospheric and Oceanic Science**
...
**A2: Business and Management has the most courses for Fall 2023. Journalism only has 12 classes that have at least one syllabus posted.**
...
**A3: The total amount for Wes Moore's committee decreased for the most part, then increased from April to May.**
...
**A4: It is 78669674 for in state and 33164994.**

I don't know why it has a row listed as out of stat because my code doesn't have that at all. But I added the two out of state columns to get my total.
...
```{r}
#Find the classes with journalism in them
umd_courses |>
  select(id, title) |>
...
**A5: Find the classes with journalism in them?**
